...
[![x-cmd/install — direnv Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/direnv.svg?lang=zh)](https://x-cmd.com/install/direnv)
...
- **Star**: 15,460 · **Fork**: 820 · **开放 issue**: 808 · **贡献者**: 244

## 累计统计

- **发布数**: 64 · **已合并 PR**: 522 · **开放 PR**: 99 · **已关闭 issue**: 438 · **开放 issue**: 370 · **提交数**: 1315
...
| last60d | 2026-07-26 | 0 | 0 | 9 | 0 | 6 | 0 |
| 90d | 2026-06-26 | 0 | 0 | 13 | 0 | 12 | 0 |
| last180d | 2026-03-28 | 0 | 0 | 25 | 0 | 18 | 0 |
| 360d | 2025-09-29 | 0 | 8 | 54 | 1 | 40 | 8 |
| last720d | 2024-10-04 | 4 | 73 | 70 | 21 | 84 | 157 |
...
direnv 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `direnv` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/direnv.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T02:55:48Z._
